    ...
    <>
      <Stack className={styles.answerContainer} tabIndex={0}>
        <Stack.Item grow>
          <Stack horizontal grow>
            ...
            {answer.answer !== 'Generating answer...' ? (
              <Stack.Item>
                <button className={styles.copyButton} onClick={() => navigator.clipboard.writeText(parsedAnswer.markdownFormatText.replace(/  \^\d+\^ /gm, ""))}>
                  Copy
                </button>
              </Stack.Item>
            ) : null}
        ...
        <Stack horizontal className={styles.answerFooter}>
          ...
          {ui?.answer_disclaimer ? (
            <Stack.Item className={styles.answerDisclaimerContainer}>
              <span className={styles.answerDisclaimer}>{ui.answer_disclaimer}</span>
            </Stack.Item>
          ) : null}
        </Stack>
        {chevronIsExpanded && (
